...
const RelatedProductCard: React.FC<RelatedProductCardProps> = ({
    ...
    return (
        <div
            ...
            <div className="relative w-full overflow-hidden  h-full bg-[#e8e8e8] dark:bg-[#393939] rounded-3xl flex items-center justify-center px-6 py-4">
                ...
                <div
                    ...
                    <svg className=" hover:scale-110 stroke-black dark:stroke-white" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 5C8.24261 5 5.43602 7.4404 3.76737 9.43934C2.51521 10.9394 2.51521 13.0606 3.76737 14.5607C5.43602 16.5596 8.24261 19 12 19C15.7574 19 18.564 16.5596 20.2326 14.5607C21.4848 13.0606 21.4848 10.9394 20.2326 9.43934C18.564 7.4404 15.7574 5 12 5Z" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
            ...
            <div className="flex flex-col w-full">
                <div className="flex justify-between items-center mt-4">
                    <p className=" text-xs whitespace-nowrap">{data.name}</p>
                ...
                <div className="flex" onClick={() => { }}>
                    <div className="flex items-center mt-4 gap-x-2 border-[0.6px] border-neutral-600 rounded-full px-4 py-[6px]">
                        <svg className="stroke-black dark:stroke-white " width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.5" y="4.5" width="14" height="12" rx="2.16667" stroke="" />
                        ...
                        <p className="mt-1 text-[11px]">add to cart</p>
                    </div>
                </div>
