...
const ProductCardShop: React.FC<ProductCardShopProps> = ({
    data
}) => {
    ...
    return (
        <div
            onClick={handleClick}
            className='group flex flex-col mt-10 items-center cursor-pointer w-full'>

            <div className="relative overflow-hidden flex items-center justify-center bg-orange-400">
                <img src={data?.mainImage} alt="mainImage" className="h-[330px] w-[100vw] object-cover" />
            ...
            <div className="flex flex-col w-full">
                ...
                <div className="flex" onClick={onAddToCart}>
                    <div className="flex items-center mt-4 gap-x-2 border-[0.6px] border-neutral-600 rounded-full px-4 py-[6px]">
                        <svg className="stroke-black dark:stroke-white " width="14" height="15" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="mt-1 text-xs">add to cart</p>
                    </div>
                </div>
